...
|------|------|------|---------------|
| **시정 (Correction)** | 발견된 부적합을 즉시 처리 | 사후 + 즉시 | 빌드 결함 긴급 수정 (마일스톤 직전) |
...
| 심각도 | 정의 | 예시 |
|------|------|------|
| Major | QMS 자체에 부재나 완전한 붕괴 | 전체 TC 작성이 누락되어 검증 없이 마일스톤 통과 |
